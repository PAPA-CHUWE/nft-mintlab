                ...
                <div className="relative z-10 grid gap-8 md:grid-cols-2 md:items-center">
                    ...
                    <div className="relative order-1 flex items-center justify-center md:order-2">
                        ...
                        <svg
                            ...
                            className="pointer-events-none absolute -right-6 -top-6 h-[240px] w-[240px] transform-gpu text-card opacity-95 md:-right-12 md:-top-12 md:h-[560px] md:w-[560px] lg:-right-20 lg:-top-36"
                            aria-hidden
                        ...
                        <div className="relative z-20 -mb-6 flex w-[220px] items-end justify-center md:w-[320px] lg:w-[340px]">
                            <div className="relative w-full">
                                <Image
                                    src="/images/nft-black.svg"
                                    alt="NFT preview"
                                    width={520}
                                    height={520}
                                    priority
